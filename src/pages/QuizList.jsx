  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-16 animate-fade-in">
      <div className="mb-12 text-center">
        <p className="text-sage-500 text-xs font-medium tracking-widest uppercase mb-3">Udforsk</p>
        <h1 className="text-3xl font-light text-stone-800 mb-3">Quizzer</h1>
        <p className="text-stone-400 font-light text-sm max-w-md mx-auto">
          Test og uddyb din forståelse af meditation.
        </p>
      </div>
